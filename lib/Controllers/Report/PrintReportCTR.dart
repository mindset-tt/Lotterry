...
class PrintReportCTR extends GetxController {
  ...
  void loadingData(String period, String branch, String unit) {
    ...
    getReportExport(period, branch, unit)
        .then((value) => loadingreportExport(value));
...
//////////// ພິມບິນຖືກການລາງວັນ /////////
  ...
  createReportAll(String period, String branch, String unit) {
    getReportAll(period, branch, unit).then((value) async {
      if (value == "200") {
        ...
        grid.style = PdfGridStyle(
            font: PdfTrueTypeFont(fontData, 12),
  ...
  createReportSale(String period, String branch, String unit) {
  ...
  createReportWon(String period, String branch, String unit) {
    getReportWon(period, branch, unit).then((value) async {
      if (value == "200") {
        ...
        PdfGridRow row = grid.rows.add();
        for (int i = 0; i < reportWonmd.length; i++) {
          row.cells[0].value = reportWonmd[i].won[i].row;
          row.cells[1].value = reportWonmd[i].won[i].branchName;
          row.cells[2].value = reportWonmd[i].won[i].deviceCode;
          row.cells[3].value =
              formated.format(double.parse(reportWonmd[i].won[i].wd1));
          row.cells[4].value =
              formated.format(double.parse(reportWonmd[i].won[i].wd2));
          row.cells[5].value =
              formated.format(double.parse(reportWonmd[i].won[i].wd3));
          row.cells[6].value =
              formated.format(double.parse(reportWonmd[i].won[i].wd4));
          row.cells[7].value =
              formated.format(double.parse(reportWonmd[i].won[i].wd5));
          row.cells[8].value =
              formated.format(double.parse(reportWonmd[i].won[i].wd6));
          row.cells[9].value =
              formated.format(double.parse(reportWonmd[i].won[i].total));
          row.cells[10].value =
              formated.format(double.parse(reportWonmd[i].balance[i].balance));
          if (i < reportWonmd.length - 1) {
            row = grid.rows.add();
          }
        }
        grid.draw(
  ...
  createReportbill(String period, String branch, String unit) {
      ...
      if (value == "200") {
        ...
        for (int i = 0; i < reportBillmd.length; i++) {
          ...
          if (reportBillmd[i].pay == null) {
            ...
            row.cells[11].value = reportBillmd[i].pay;
          }
          if (reportBillmd[i].pay == null) {
            row.cells[11].value = "ວ່າງເປົ່າ";
          } else {
  ...
  createReportExport(String period, String branch, String unit) {
    getReportBill(period, branch, unit).then((value) async {
      if (value == "200") {
        if (branch == "0") {
          branch = "All";
        ...
        PdfGridRow row = grid.rows.add();
        for (int i = 0; i < reportExportmd.length; i++) {
          row.cells[0].value = reportExportmd[i].sale[i].row;
          row.cells[1].value = reportExportmd[i].sale[i].deviceCode;
          row.cells[2].value =
              formated.format(double.parse(reportExportmd[i].sale[i].sd1));
          row.cells[3].value =
              formated.format(double.parse(reportExportmd[i].sale[i].sd2));
          row.cells[4].value =
              formated.format(double.parse(reportExportmd[i].sale[i].sd3));
          row.cells[5].value =
              formated.format(double.parse(reportExportmd[i].sale[i].sd4));
          row.cells[6].value =
              formated.format(double.parse(reportExportmd[i].sale[i].sd5));
          row.cells[7].value =
              formated.format(double.parse(reportExportmd[i].sale[i].sd6));
          row.cells[8].value =
              formated.format(double.parse(reportExportmd[i].data[i].won.wd1));
          row.cells[9].value =
              formated.format(double.parse(reportExportmd[i].data[i].won.wd2));
          row.cells[10].value =
              formated.format(double.parse(reportExportmd[i].data[i].won.wd3));
          row.cells[11].value =
              formated.format(double.parse(reportExportmd[i].data[i].won.wd4));
          row.cells[12].value =
              formated.format(double.parse(reportExportmd[i].data[i].won.wd5));
          row.cells[13].value =
              formated.format(double.parse(reportExportmd[i].data[i].won.wd6));
          row.cells[14].value =
              formated.format(double.parse(reportExportmd[i].data[i].balance));
          row.cells[15].value = reportExportmd[i].sale[i].branchName;
          row.cells[16].value = reportExportmd[i].sale[i].dateOffline;
          if (i < reportExportmd.length - 1) {
            row = grid.rows.add();
          }
        }
        grid.draw(
